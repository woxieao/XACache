...
namespace XACache
{
...

    {
        ...
        /// <returns></returns>
        public static string CalculateMd5Hash(string input, string salt = Salt)
        {
            try
            {
                var md5 = MD5.Create();
        ...
        /// 返回当前时间/缓存时间
        /// </summary>
        /// <param name="changeParam">传入不同的数字即可刷新时间,测试本方法是否正常工作</param>
        /// <returns>当前时间</returns>
        public static DateTime Just4Test(int changeParam)
        {
            return DateTime.Now;
        }
